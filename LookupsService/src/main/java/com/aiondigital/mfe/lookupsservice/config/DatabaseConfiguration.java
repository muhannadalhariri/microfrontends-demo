package com.aiondigital.mfe.lookupsservice.config;
...
@Configuration
@EnableMongock
@EnableElasticsearchRepositories("com.aiondigital.mfe.lookupsservice.repository.search")
@EnableMongoRepositories(
    basePackages = "com.aiondigital.mfe.lookupsservice.repository",
