...
@RestController
@RequestMapping("/api/lookups-service-kafka")
public class LookupsServiceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(LookupsServiceKafkaResource.class);
    ...
    public LookupsServiceKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
