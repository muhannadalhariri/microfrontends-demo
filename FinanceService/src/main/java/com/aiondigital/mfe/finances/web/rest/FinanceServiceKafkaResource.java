...
import com.aiondigital.mfe.finances.config.KafkaSseConsumer;
import com.aiondigital.mfe.finances.config.KafkaSseProducer;
...
@RestController
@RequestMapping("/api/finance-service-kafka")
public class FinanceServiceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(FinanceServiceKafkaResource.class);
    ...
    public FinanceServiceKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
