package com.aiondigital.mfe.finances.config;
...
@Configuration
@EnableMongock
@EnableElasticsearchRepositories("com.aiondigital.mfe.finances.repository.search")
@EnableMongoRepositories(
    basePackages = "com.aiondigital.mfe.finances.repository",
