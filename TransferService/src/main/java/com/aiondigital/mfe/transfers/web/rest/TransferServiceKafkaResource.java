...
import com.aiondigital.mfe.transfers.config.KafkaSseConsumer;
import com.aiondigital.mfe.transfers.config.KafkaSseProducer;
...
@RestController
@RequestMapping("/api/transfer-service-kafka")
public class TransferServiceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(TransferServiceKafkaResource.class);
    ...
    public TransferServiceKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
