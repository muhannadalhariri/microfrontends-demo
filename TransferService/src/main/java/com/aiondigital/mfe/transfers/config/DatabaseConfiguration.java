package com.aiondigital.mfe.transfers.config;
...
@Configuration
@EnableMongock
@EnableElasticsearchRepositories("com.aiondigital.mfe.transfers.repository.search")
@EnableMongoRepositories(
    basePackages = "com.aiondigital.mfe.transfers.repository",
