...
import com.aiondigital.mfe.transfers.service.TransactionService;
...
/**
 * REST controller for managing {@link com.aiondigital.mfe.transfers.domain.Transaction}.
 */
@RestController
@RequestMapping("/api")
public class TransactionResource {
    ...
    private static final String ENTITY_NAME = "transferServiceTransaction";
    ...
    public ResponseEntity<Transaction> updateTransaction(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, transaction.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Transaction> partialUpdateTransaction(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, transaction.getId())
        );
    }
