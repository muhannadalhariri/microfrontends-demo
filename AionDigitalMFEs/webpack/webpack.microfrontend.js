  ...
  return {
    plugins: [
      new ModuleFederationPlugin({
        remotes: {
          lookupsservice: 'lookupsservice@/services/lookupsservice/remoteEntry.js',
          financeservice: 'financeservice@/services/financeservice/remoteEntry.js',
          transferservice: 'transferservice@/services/transferservice/remoteEntry.js',
        },
        shared: {
