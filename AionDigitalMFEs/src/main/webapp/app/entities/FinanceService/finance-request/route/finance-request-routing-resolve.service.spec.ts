...
describe('FinanceRequest routing resolve service', () => {
  ...
  let routingResolveService: FinanceRequestRoutingResolveService;
  ...
  beforeEach(() => {
    ...
    routingResolveService = TestBed.inject(FinanceRequestRoutingResolveService);
  ...
  describe('resolve', () => {
    it('should return IFinanceRequest returned by find', () => {
      ...
      expect(resultFinanceRequest).toEqual({ id: 'ABC' });
    });
