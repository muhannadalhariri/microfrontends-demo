...
type CardFormGroupContent = {
  ...
  nameAr: FormControl<ICard['nameAr']>;
  nameEn: FormControl<ICard['nameEn']>;
  cardTypeId: FormControl<ICard['cardTypeId']>;
  cardReference: FormControl<ICard['cardReference']>;
};
...
export class CardFormService {
  createCardFormGroup(card: CardFormGroupInput = { id: null }): CardFormGroup {
    ...
    return new FormGroup<CardFormGroupContent>({
      ...
      nameAr: new FormControl(cardRawValue.nameAr),
      nameEn: new FormControl(cardRawValue.nameEn),
      cardTypeId: new FormControl(cardRawValue.cardTypeId),
      cardReference: new FormControl(cardRawValue.cardReference),
    });
  }
