...
describe('TransactionDetails routing resolve service', () => {
  ...
  let resultTransactionDetails: ITransactionDetails | null | undefined;
  ...
  describe('resolve', () => {
    it('should return ITransactionDetails returned by find', () => {
      ...
      expect(resultTransactionDetails).toEqual({ id: 'ABC' });
    });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultTransactionDetails).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ITransactionDetails>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 'ABC' };
